        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          >
            <div className="h-48 overflow-hidden">
              <img src="/images/ak-creaciones/emprendedores-artesanos.jpg" alt="Exhibidores para aros en madera" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="p-6">
          ...
          >
            <div className="h-48 overflow-hidden">
              <img src="/images/ak-creaciones/turismolocal.jpg" alt="Souvenirs Turísticos" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="p-6">
          ...
          >
            <div className="h-48 overflow-hidden relative">
              ...
              <img src="/images/ak-creaciones/NFC QR.jpg" alt="Tecnología NFC" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
            </div>
            <div className="p-6">
